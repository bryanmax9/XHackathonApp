...
import 'tweets_model.dart';
export 'tweets_model.dart';
...
class _TweetsWidgetState extends State<TweetsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TweetsModel());
  }
                ...
                children: [
                  StreamBuilder<List<TweetsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<TweetsRecord> listViewTweetsRecordList =
                          snapshot.data!;
