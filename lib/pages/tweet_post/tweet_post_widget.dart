...
import 'tweet_post_model.dart';
export 'tweet_post_model.dart';

class TweetPostWidget extends StatefulWidget {
  const TweetPostWidget({super.key});
...
class _TweetPostWidgetState extends State<TweetPostWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TweetPostModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Share, What are You Doing Right Now?',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Readex Pro',
                          letterSpacing: 0.0,
                        ),
                ...
                FFButtonWidget(
                  onPressed: () async {
                    await TweetsRecord.collection.doc().set({
