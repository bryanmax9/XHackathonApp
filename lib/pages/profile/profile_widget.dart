              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          Align(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                'https://i.imgur.com/v5SkZkA.jpeg',
                          ...
                          Align(
                            alignment: const AlignmentDirectional(-0.88, 1.58),
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(50.0, 0.0, 0.0, 30.0),
                      child: Text(
                        'Friends:',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Image.network(
                                          listViewFriendsRecord.profileImage,
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Padding(
                                          ...
                                          children: [
                                            Align(
                                              alignment: const AlignmentDirectional(
                                                  -1.0, -1.0),
                                              child: Text(
                                                '@${listViewFriendsRecord.username}',
                                                style:
                                            ...
                                            Text(
                                              'Friendship Level: ${listViewFriendsRecord.friendshipLevel}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
